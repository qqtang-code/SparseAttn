...
max_toks=${MAX_TOKS:-1024}


attn_type=${ATTN_TYPE:-"infllmv2"}

# Dataset configuration
dataset=${DATASET:-"/data2/public_data/Pre_filter"}

# Create run name
extra_name="update_qkv_only_blocksize_64_topk_64_window_2048"

run_name="infllmv2_qwen3_$(basename $model)_bsz${bsz}_steps${steps}_lr${lr}_warmup${warmup}_${extra_name}${suffix}"
